...
-(UIView *)graphsHeader
{
    ...
    if (!_graphsHeader){
        ...
        UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 40, 320, 50)];
        view.backgroundColor = [UIColor clearColor];
...
/*
 ...
 CGRect headerViewFrame = self.tableOfContentsHeader.frame;
 
 self.tableOfContentsHeader.frame = CGRectMake(self.tableOfContentsHeader.frame.origin.x , self.tableOfContentsHeader.frame.origin.y + tableBounds.origin.y, tableOfContentsHeader.frame.size.width, self.tableOfContentsHeader.frame.size.height);
