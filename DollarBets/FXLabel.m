...
- (void)drawRect:(CGRect)rect
{
    ...
    switch (self.textAlignment)
    {
        ...
        {
           //textRect.origin.x = textRect.size.width - rect.size.width ;
            break;
        }
    ...
    if (needsMask)
    {
        ...
        if (hasGradient)
        {
           ...
           // CGColorRef endColor = [self color:gradientEndColor.CGColor blendedWithColor:self.textColor.CGColor];
            ...
            CFArrayRef colors = (__bridge CFArrayRef)[NSArray arrayWithObjects:(id)[self color:gradientStartColor.CGColor blendedWithColor:self.textColor.CGColor],
                                             (id)[self color:gradientEndColor.CGColor blendedWithColor:self.textColor.CGColor], nil];
